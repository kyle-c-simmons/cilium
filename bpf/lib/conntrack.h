...
static __always_inline int
ct_extract_ports6(struct __ctx_buff *ctx, struct ipv6hdr *ip6, __s64 fraginfo,
...
__ct_lookup6(const void *map, struct ipv6_ct_tuple *tuple, struct __ctx_buff *ctx,
	     __s64 fraginfo, int l4_off, enum ct_dir dir, enum ct_scope scope,
...
static __always_inline int
ct_extract_ports4(struct __ctx_buff *ctx, struct iphdr *ip4, __s64 fraginfo,
