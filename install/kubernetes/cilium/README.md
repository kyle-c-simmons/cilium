...
| authentication.mutual.spire.install.initImage | object | `{"digest":"sha256:29c2339e8727db1f58366f70f63063154c8230beb9ce1833380b71fa92bd0b89","override":null,"pullPolicy":"Always","repository":"docker.io/library/busybox","tag":"1.37.0","useDigest":true}` | init container image of SPIRE agent and server |
...
| underlayProtocol | string | `"ipv4"` | Underlay protocol for the tunnel. |
